...
class CustomAzureSearch:
    def __init__(self,
        ...
        self.model_name = model_name # to convert input query to embeddings (raw vector)
    ...
    def get_embedding_query_vector(self, query):
        ...
        Returns:
             is the embeddings of the input query (raw vector)
    ...
    def get_vectorized_query(self, query,exhaustive_knn=False):
        ...
        """
        query_vector = self.get_embedding_query_vector(query) # return is the embeddings of the input query (raw vector)
    ...
    def get_results_vector_search(self,query,
        ...
        results = self.client.search(  
            ...
            select=list_fields, # ["line", "filename", ...],
